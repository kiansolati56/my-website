...
const getDitherValue = (): number => {
    if (typeof props.dither === 'boolean') {
        return props.dither ? 1 : 0
    }
...
const setupRenderer = () => {
    ...
    const tintVec = hexToRgb(props.tint)
    ...
    const program = new Program(gl, {
        ...
        uniforms: {
            ...
            uGridMul: {
                value: new Float32Array(props.gridMul)
            },

            uDigitSize: {
                value: props.digitSize
            },

            uScanlineIntensity: {
                value: props.scanlineIntensity
            },

            uGlitchAmount: {
                value: props.glitchAmount
            },

            uFlickerAmount: {
                value: props.flickerAmount
            },

            uNoiseAmp: {
                value: props.noiseAmp
            },
            ...
            uUseMouse: {
                value: props.mouseReact ? 1 : 0
            },

            uPageLoadProgress: {
                value: props.pageLoadAnimation ? 0 : 1
            },

            uUsePageLoadAnimation: {
                value: props.pageLoadAnimation ? 1 : 0
            },
